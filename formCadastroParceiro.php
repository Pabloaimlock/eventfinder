...
<div class="box">
    <form method="POST" class="escolha" action="./area-restrita/cadastroParceiro.php">
        <table width="600px" border="0" align="center">
            <h2>Cadastro de Parceiro</h2>

            <label for="nomeParceiro">Nome:</label>
            <input class="b" type="text" id="nomeParceiro" name="nomeParceiro" required><br><br>

            <label for="cnpjParceiro">CNPJ:</label>
            <input class="b" type="text" id="cnpjParceiro" name="cnpjParceiro" required><br><br>

            <label for="celParceiro">Celular:</label>
            <input class="b" type="text" id="celParceiro" name="celParceiro" required><br><br>

            <label for="emailParceiro">Email:</label>
            <input class="b" type="email" id="emailParceiro" name="emailParceiro" required><br><br>

            <label for="senhaParceiro">Senha:</label>
            <input class="b" type="password" id="senhaParceiro" name="senhaParceiro" required><br><br>

            <label for="cep">CEP:</label>
            <input class="b" type="text" id="cep" name="cep" required><br><br>

            <label for="logradouro">Logradouro:</label>
            <input class="b" type="text" id="logradouro" name="logradouro" required><br><br>

            <label for="numero">Número:</label>
            <input class="b" type="text" id="numero" name="numero" required><br><br>

            <label for="bairro">Bairro:</label>
            <input class="b" type="text" id="bairro" name="bairro" required><br><br>

            <label for="cidade">Cidade:</label>
            <input class="b" type="text" id="cidade" name="cidade" required><br><br>

            <label for="estado">Estado:</label>
            <input class="b" type="text" id="estado" name="estado" required><br><br>
