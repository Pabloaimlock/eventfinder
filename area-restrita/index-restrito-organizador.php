...
<?php } ?>
        ...
        var optionsIngressos = {
            ...
            chartArea: {width: '50%'},
            series: {
        0: {color: 'rgb(255, 128, 0)'}, // Define a cor laranja para ingressos de camarote
        1: {color: 'rgb(0, 0, 255)'} // Define a cor azul para ingressos de pista
    }
        };
        ...
        <div class="container">
            ...
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    ?>
                    <p id="card-text" class="tit">Ingressos camarote vendidos: <?php echo $quantidadeCamarote['camarote']; ?></p>
                    <p id="card-text"class="tit">Ingressos pista vendidos: <?php echo $quantidadePista['pista']; ?></p>
